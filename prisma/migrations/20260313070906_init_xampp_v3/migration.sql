...
CREATE TABLE `Order` (
    ...
    `status` ENUM('PENDING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'PROCESSING', 'REFUNDED') NOT NULL DEFAULT 'PENDING',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `OrderLog` (
    ...
    `status` ENUM('PENDING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'PROCESSING', 'REFUNDED') NOT NULL,
...
CREATE TABLE `UserAvatar` (
    ...
    `bodyType` VARCHAR(191) NOT NULL DEFAULT 'ATHLETIC',
    `skinTone` VARCHAR(191) NOT NULL DEFAULT '#E0AC69',
    `height` DOUBLE NOT NULL DEFAULT 1.8,
    `weight` DOUBLE NOT NULL DEFAULT 75,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `UserAvatar_userId_key`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
